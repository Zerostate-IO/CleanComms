...
3. Make your changes.
4. Ensure your code follows our [Code Style](#code-style).
...
### CRITICAL: Plan Safekeeping
CleanComms uses a structured planning system. **Any changes to `.sisyphus/plans` must be committed along with the related work.** This ensures that the project's roadmap and implementation remain synchronized. Pull requests that modify implementation without updating the corresponding plan (or vice versa) may be rejected.

## Community Health
- Please adhere to our [Code of Conduct](CODE_OF_CONDUCT.md).
- For security concerns, please refer to our [Security Policy](SECURITY.md).
- For support, please refer to our [Support Guide](SUPPORT.md).
